...
#Plot of vascular richness as a function of latitude in bogs and fens (Figure 2A)
...
#Verify independent effects of variables using function anova (to see if moss richness increases with latitude when other variables are not considered)
anova(result)
...
#Plot of moss richness as a function of latitude in bogs and fens (Figure 2B)
...
#Plot of vascular FDis as a function of latitude in bogs and fens (Figure 2C)
...
#Plot of moss richness as a function of latitude in bogs and fens (Figure 2D)
